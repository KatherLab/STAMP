...
def test_train_deploy_integration(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="stamp_test_train_deploy_") as tmp_dir:
        dir = Path(tmp_dir)
        (dir / "train").mkdir()
        (dir / "deploy").mkdir()
        ...
        deploy_categorical_model_(
            output_dir=dir / "deploy_output",
            checkpoint_paths=[dir / "train_output" / "model.ckpt"],
