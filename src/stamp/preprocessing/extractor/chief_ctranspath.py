...
def chief_ctranspath(
    model_path: Path | None = None,
) -> Extractor[ctranspath._SwinTransformer]:
    ...
    model = ctranspath._swin_tiny_patch4_window7_224(
        embed_layer=ctranspath._ConvStem, pretrained=False
    )
