...
from .base import deploy, train
from .data import SKLearnEncoder, get_cohort_df, get_target_enc
...
def train_categorical_model_(
    ...
    *,
    ...
    train_patients, valid_patients = train_test_split(
        df.PATIENT, stratify=df[target_label], random_state=1337
    )
...
def deploy_categorical_model_(
    ...
    *,
    ...
    test_df = get_cohort_df(
        clini_table, slide_table, feature_dir, target_label, categories
    )
